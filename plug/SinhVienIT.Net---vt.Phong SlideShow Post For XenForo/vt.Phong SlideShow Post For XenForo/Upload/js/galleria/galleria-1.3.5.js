...
Galleria = function() {
    ...
    var divs =  'container stage images image-nav image-nav-left image-nav-right ' +
                ...
                'loader counter tooltip vtPhongfacebook',
        spans = 'current total';
    ...
    */
    ...
    _init: function() {
        ...
        this.append({
            ...
            'container' :
                ['stage', 'thumbnails-container', 'info', 'tooltip', 'vtPhongfacebook']
        });
...
this.prependChild( 'info', 'myElement' );
    ...
    */
    ...
    /**
        sonnn extend function for vtPhong slide show
    */
    clickfullsrceen: function() {

        this.enterFullscreen();
        this.play(5000);
        var phtml = $('.facebookLike').html();
        $('.galleria-vtPhongfacebook').html(phtml);
