...
class XenForo_Tfa_PHPGangsta_GoogleAuthenticator
{
	...
	/**
	 * Gets the otpauth protocol URL for use when generating the QR code.
	 *
	 * @param string $name
	 * @param string $secret
	...
	public function getOtpAuthUrl($name, $secret, $title = null) {
		$url = 'otpauth://totp/'.rawurlencode($name).'?secret='.urlencode($secret);
        if(isset($title)) {
    ...
    public function getQRCodeGoogleUrl($name, $secret, $title = null) {
        $url = $this->getOtpAuthUrl($name, $secret, $title);
     ...
     *
     * @param int $length
     * @return XenForo_Tfa_PHPGangsta_GoogleAuthenticator
     */
