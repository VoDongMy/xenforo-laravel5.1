 ...
 */
abstract class XenGallery_Option_StyleChooser
{
	/**
	...
	{
		$styles = array(0 => '');
		$styles = $styles + XenForo_Model::create('XenForo_Model_Style')->getStylesForOptionsTag($preparedOption['option_value']);
		$preparedOption['formatParams'] = $styles;
