...
class XenGallery_SitemapHandler_UserAlbum extends XenGallery_SitemapHandler_Abstract
{
	...
	{
		if (!$entry['xengallery_album_count'])
		{
			return false;
		}
	...
	{
		$result = array(
			'loc' => XenForo_Link::buildPublicLink('canonical:xengallery/users/albums', $entry),
			'priority' => 0.3
		);
	...
	{
		return 'xengallery_sitemap_user_albums';
	}
}