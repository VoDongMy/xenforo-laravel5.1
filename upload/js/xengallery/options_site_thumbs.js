...
!function($, window, document, _undefined)
{
	 ...
	 */
	XenForo.MediaSiteThumbListener = function($element) { this.__construct($element); };
	XenForo.MediaSiteThumbListener.prototype =
	{
	...
	XenForo.register('li.MediaSiteThumbListener', 'XenForo.MediaSiteThumbListener');
